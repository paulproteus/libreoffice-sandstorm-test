...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "1gsfa4ja1n1ex4vg6pr68ghyak5ash1zwdjkq9v3m12y8hguztm0",
  ...
  sourceMap = (
    ...
    searchPath = [
      ...
      ( packagePath = "proc/version",
        sourcePath = "/opt/app/.sandstorm/fake-proc-version" ), # fake out libreoffice
      ( packagePath = "proc/mounts",
        sourcePath = "/opt/app/.sandstorm/fake-proc-mounts" ), # fake out libreoffice
      ( packagePath = "proc/filesystems",
        sourcePath = "/opt/app/.sandstorm/fake-proc-filesystems" ), # fake out libreoffice
      ( packagePath = "proc/meminfo",
        sourcePath = "/opt/app/.sandstorm/fake-proc-meminfo" ), # fake out libreoffice
      ( packagePath = "proc/self/exe",
        sourcePath = "/opt/app/.sandstorm/fake-proc-self-exe" ), # fake out libreoffice
      ( packagePath = "etc/passwd",
        sourcePath = "/opt/app/.sandstorm/fake-etc-passwd" ), # fake out libreoffice
